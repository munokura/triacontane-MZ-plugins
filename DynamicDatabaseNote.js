...
@plugindesc Database memo field dynamic setting plugin
@author Triacontane
@license MIT License
...
Overwrites database memo fields during gameplay.
Specify the data to be changed and the IDs before and after the change.
Specifying a non-existent ID or database will result in an error.

Note:
Depending on how the memo field of the plugin you are using is used,
this plugin's changes may not be reflected.
In such cases, it will be difficult to address this issue with this plugin.
...
@desc Overwrites the memo field of the specified data with other data.
@arg destId
@text Overwrite destination ID
@desc The ID of the data to be overwritten.
@type actor
@default 0
@arg srcId
@text Overwrite source ID
@desc The ID of the original data to be overwritten.
@type actor
@default 0

@command CHANGE_NOTE_CLASS
@text Occupation memo field change
@desc Overwrites the memo field of the specified data with other data.
@arg destId
@text Overwrite destination ID
@desc The ID of the data to be overwritten.
...
@text Enemy character memo column change
@desc Overwrites the memo field of the specified data with other data.
@arg destId
@text Overwrite destination ID
@desc The ID of the data to be overwritten.
