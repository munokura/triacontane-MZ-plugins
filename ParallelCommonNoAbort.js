...
@plugindesc Parallel common interrupt prevention plugin
@author Triacontane
@license MIT License
...
This plugin changes the specification so that if a condition switch is turned
OFF while a parallel common event is being executed, it will not immediately
abort, but will execute the command to completion before terminating.
This does not apply to parallel map event processing.
