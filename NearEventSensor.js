...
Detects nearby events and applies effects to them.
Improves usability by informing the player of actionable events.
Enter the detection settings in the "Detailed Settings List" parameter,
and enter the following in the event's memo field.
<NESDetail:sensor01> # Apply settings for identifier [sensor01]
<NESDetail:sensor01> # Same as above
...
@param DetailList
@text Settings List
@desc This is a list of speech bubble settings.
@type struct<Detail>[]
@default []
...
@desc Only enable the effect if the player is facing the event.
@type boolean
@default false
...
@desc When enabled, control characters cannot be used in parameters, but performance may improve.
@type boolean
@default false
*/
...
@param Alpha
@desc Strength information (0-255)
@type number
@default 255
@min 0
@max 255
...
/*~struct~Range:
@param Left
@text Number of squares left
@desc Number of squares to the left
@type number
@default 0

@param Right
@text Number of squares to the right
@desc Number of squares to the right
@type number
@default 0

@param Up
@text Number of squares above
@desc Number of squares upwards
@type number
@default 0

@param Down
@text Number of squares below
@desc Number of squares downwards
@type number
@default 0
*/
...
@param Id
@text identifier
@desc The setting identifier. Note that if left empty it will apply to all events.
@default sensor01

@param Page
@text Page Conditions
@desc It will be enabled when the event page is the specified value. If you specify 0, it will be enabled on all pages.
@type number
@default 0

@param Switch
@text Switch Condition
@desc It is enabled when the specified switch is ON. If you specify 0, it is always enabled.
@type switch
@default 0

@param SelfSwitch
@text Self-switching conditions
@desc It is enabled when the specified self switch is ON. If not specified, it is always enabled.
@type select
@option A
@option B
@option C
...
@desc The sensor is activated when various conditions are not met.
@type boolean
@default false

@param SensorDistance
@text Sensing distance
@desc The distance at which the event is detected.
@type number
@default 2

@param SensorRange
@text Detection range
@desc Set the range of event detection in detail up, down, left, and right.
@type struct<Range>
@default {}
...
@text Sensor Self Switch
@desc It is a self-switch that automatically turns on when it senses something and turns off when it moves away.
@type select
@option A
@option B
@option C
...
@param SensorSwitch
@text Sensor switch
@desc This switch automatically turns on when it detects something and turns off when it moves away.
@type switch
@default 0
*/
