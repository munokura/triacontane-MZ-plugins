...
@plugindesc Item common event parallelization plugin
@author Triacontane
@license MIT License
...
if the target trigger is "parallel processing," it will be executed in
parallel.
The switch specified as the trigger does not turn ON, but the specified common
event is executed in parallel processing only once.

If you invoke a common item from the menu screen while an event is running,
