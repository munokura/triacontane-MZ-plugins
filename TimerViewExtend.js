...
@plugindesc Timer Display Extension Plugin
@author Triacontane
@license MIT License
...
Allows you to customize the timer's display, such as its font and position.
This plugin does not affect the timer itself.
...
@param fontFace
@text font
@desc Timer font. Requires a separate font loading plug-in.
@type string

@param fontSize
@text Font size
@desc The font size of the timer.
@type number
@default 0

@param fontColor
@text Font color
@desc The timer font color. Specify the system color or CSS directly.
@type color
@default 0

@param outlineColor
@text Outline Color
@desc The outline color of the timer. You can specify the color using the system color or CSS directly.
@type color
@default 0

@param outlineWidth
@text Outline Width
@desc The timer outline width. Specify 0 for no outline.
@type number
@default 3

@param format
@text format
@desc Timer display format: %1 is the remaining minutes, %2 is the remaining seconds.
@default %1:%2

@param basePosition
@text Base display position
@desc This is the base display position of the timer.
@type select
@default upperCenter
@option top center
@value upperCenter
...
@desc The X coordinate adjustment for the timer.
@type number
@default 0
@min -9999
@max 9999
...
@desc The Y coordinate adjustment for the timer.
@type number
@default 0
@min -9999
@max 9999
...
@param timerWidth
@text Timer width
@desc The width of the timer. Specifying 0 will set it to the default width.
@type number
@default 0

@param timerHeight
@text Timer Height
@desc The height of the timer. Specify 0 for the default width.
@type number
@default 0

@param visibilitySwitchId
@text Display Switch
@desc The timer will only be displayed when the switch with the specified number is ON. If you specify 0, it will be the default (display only when moving).
@type switch
@default 0
*/
