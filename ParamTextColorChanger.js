...
@plugindesc Parameter text color change plug-in
@author Triacontane
@license MIT License
...
Changes the text color of HP, MP, and TP values based on their current
percentage.
...
@param HpColors
@text HP Text Color
@desc Changes the HP text color according to the percentage. Items are evaluated in order from the top of the list.
@type struct<Color>[]
@default []

@param MpColors
@text MP Text Color
@desc Changes the text color of MP according to the percentage. They are evaluated in order from the top of the list.
@type struct<Color>[]
@default []

@param TpColors
@text TP Text Color
@desc Changes the text color of TP according to the percentage. It is evaluated in order from the top of the list.
@type struct<Color>[]
@default []

@param NameColorNoChange
@text Do not change the name color
@desc The default setting of linking the actor name text color to HP color will be removed.
@type boolean
@default false
*/
...
/*~struct~Color:
@param operand
@text Percentage setting value
@desc The percentage of the parameter (0% - 100%) when determining the condition.
@type number
@default 0
@min 0
@max 100
...
@param sign
@text conditional sign
@desc Sets whether the parameter percentage is greater than or equal to the specified value or less than or equal to the specified value.
@type select
@default ≥
@option ≥ (if greater than or equal to the specified percentage)
@value ≥
@option ≤ (if below specified percentage)
@value ≤

@param colorIndex
@text Color Index
@desc The color index (a number specified by \c[n]) that will change when the specified condition is met.
@type color
@default 0
*/
