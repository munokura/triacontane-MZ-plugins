...
@param fileName
@text pop-up file
@desc Image file to be popped up. If specified, it takes precedence over the text display.
@type file
@dir img/pictures

@param stateId
@text state ID
@desc State ID for popup display target. No need to specify for non-state list.
@type state

@param invalidSkillList
@text Disabled Skill List
@desc This popup is not used by the specified skill.
@type skill[]
@default []

@param color
@text pop-up collar
@desc Popup color; specifies a CSS color specification string.
@type combo
...
@param textColor
@text text color
@desc Specify popup color from text color (\c[n]).
@type color

@param textSize
@text text size
@desc The size of the popup text; if 0 is specified, it will be the default size.
@default 0

@param fontFace
@text font name
@desc Font name for popup text. If specified, a separate font loading plug-in is required.

@param flash
@text flush
@desc Flash color at pop-up.
@type struct<Color>

@param se
@text sound effect
@desc Sound effect at pop-up.
@type struct<SE>
*/
...
@param red
@text red
@desc The degree of redness of the flash.
@type number
@default 255
@max 255
...
@param green
@text green
@desc The degree of greenness of the flash.
@type number
@default 255
@max 255
...
@param blue
@text blue
@desc The degree of blue color of the flash.
@type number
@default 255
@max 255
...
@param pan
@text position
@desc Localization (left-right balance).
@type number
@default 0
@min -100
@max 100
