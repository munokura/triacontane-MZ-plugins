...
Keeps the user and result of the most recent action in dedicated variables.
You can reference this in common events called by skills, etc.
...
- Skill
$gameTemp.lastSkill()
- Action result (success or evasion check)
The plugin parameters are stored in the switches and variables.
...
@desc The flag items from the action results are stored in the specified switch.
@type struct<FlagResult>[]
@default []

@param variableResultList
@text Numerical result list
@desc The numerical values and array items of the action results will be stored in the specified variables.
@type struct<VariableResult>[]
@default []

@param lastTargetActorId
@text Target actor ID variable
@desc This is the variable number that stores the target actor ID of the previous action.
@type variable
@default 0

@param lastTargetEnemyId
@text Target enemy ID variable
@desc This is the variable number that stores the target enemy ID of the previous action.
@type variable
@default 0

@param lastSubjectActorId
@text User actor ID variable
@desc This is the variable number that stores the actor ID of the user of the previous action.
@type variable
@default 0

@param lastSubjectEnemyId
@text User enemy ID variable
@desc This is the variable number that stores the enemy ID of the user of the previous action.
@type variable
@default 0
*/
...
@param property
@text Properties
@desc The value of the specified property is stored in the switch.
@type select
@default missed
@option Miss
@value missed
...
@param variableId
@text Variable ID
@desc The variable number where the numeric item is stored.
@type variable
@default 1

@param property
@text Properties
@desc The value of the specified property is stored in the variable.
@type select
@default hpDamage
...
@value tpDamage
@option Additional State Array
@value addedStates
@option Cancellation state array
@value removedStates
@option Additional buff array
@value addedBuffs
@option Additional debuff array
@value addedDebuffs
@option Buff removal sequence
@value removedBuffs
@option Attribute multiplier
@value elementRate
*/
