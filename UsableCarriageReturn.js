...
@plugindesc Plugin that can use line break codes
@author Triacontane
@license MIT License
...
You can now use line breaks anywhere in a window.
Enter "\n" wherever you want a line break in the database or message window.
This is primarily used when you want to add a third line to a database
description or profile field.
...
@desc Number of lines in the help window. Specifying 0 will default to 2 lines.
@type number
@default 0

@param profileLineNumber
@text Profile lines
@desc The number of lines in the profile. Specifying 0 will default to 2 lines.
@type number
@default 0
*/
