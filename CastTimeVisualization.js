...
@plugindesc Cast Time Visualization Plugin
@author Triacontane
@license MIT License
...
Visualizes casting time with a gauge.
While casting, the progress gauge will change to a cast gauge.

Cast time is activated by setting a negative value for the skill or item's
"Speed Compensation."
...
@text Cast gauge color (left)
@desc This is the color of the left side of the cast gauge. Enter the system color value.
@type number
@default 2

@param castGaugeColorRight
@text Cast gauge color (right)
@desc This is the color of the right side of the cast gauge. Enter the system color value.
@type number
@default 3
*/
