...
@plugindesc Skill type hide plugin
@author Triacontane
@license MIT License
...
Hides or makes hidden skill types unselectable via actor commands.
(Currently, they are selectable via actor commands but not on the skill
selection screen.)
...
@param hidden
@text hidden
@desc Hides the sealed skill type. (If disabled, it cannot be selected.)
@type boolean
@default false
*/
