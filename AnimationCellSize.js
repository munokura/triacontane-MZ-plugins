...
@plugindesc Animated Cell Resize Plugin
@author Triacontane
@license MIT License
...
Allows you to change the cell size of MV-style animations.
Please note that this will not be reflected in the editor.
...
@param imageList
@text Image List
@desc A list of animated images you want to resize.
...
@desc This is the animation file for which you want to change the cell size.
@type file
@dir img/animation

@param sizeWidth
@text Cell size (horizontal)
@desc The horizontal cell size you want to change.
@type number
@default 192

@param sizeHeight
@text Cell size (vertical)
@desc The vertical cell size you want to change.
@type number
@default 192
*/
