...
@param name
@text Command Name
@desc This is the command name that will be displayed on the title screen.
@default Another New Game

@param location
@text Map Coordinates
@desc The map coordinates of the destination. If not specified, the location will not change. Requires v1.9.0 or later.
@type location
@default {}

@param hidden
@text Default hidden
@desc Hides choices by default, can be enabled with the plugin command.
@type boolean
@default false

@param disable
@text Default disabled
@desc Makes the options unselectable by default. Can be enabled with the plugin command.
@type boolean
@default false

@param addPosition
@text additional position
@desc This is where you can add commands for Another New Game. (1: Above New Game, 2: Above Continue, 3: Above Options)
@type select
@default 0
...
@param demoWaitFrame
@text Demo Wait Frames
@desc It will start when the specified number of frames of inactivity has passed. If you specify this, it will not appear in the command.
@type number
@default 0

@param switchId
@text Enable at start switch
@desc You can specify switches that will automatically turn on when starting Another New Game.
@type switch
@default 0

@param fileLoad
@text File Load
@desc When you select Another New Game, you will be taken to a loading screen and your existing save data will be loaded.
@type boolean
@default false

@param noFadeout
@text Fade out disabled
@desc Audio and screen will no longer fade out when selecting Another New Game.
@type boolean
@default false
*/
