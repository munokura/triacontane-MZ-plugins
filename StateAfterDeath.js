...
@plugindesc Continuation state plugin after being killed
@author Triacontane
@license MIT License
...
You can create a state that persists even after being defeated in battle.

Please specify the target state via the parameters.
...
@param states
@text Target state
@desc A list of states that continue even after being defeated.
@type state[]
@default []

@param stateIdStart
@text Target state (start of range setting)
@desc This is the starting ID when you want to specify a range of states that continue even after being incapacitated.
@type state
@default 0

@param stateIdEnd
@text Target state (end of range setting)
@desc This is the end ID if you want to specify a range of states that continue even after being incapacitated.
@type state
@default 0

@param considerRecoverAll
@text Considering full recovery
@desc The state will not be removed even if the character is fully recovered, not just if they are incapacitated, but will remain permanently inflicted.
@type boolean
@default false
*/
