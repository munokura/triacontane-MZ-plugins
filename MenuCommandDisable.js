...
@plugindesc Menu command prohibition control plugin
@author Triacontane
@license MIT License
...
Temporarily disable or hide menu commands during gameplay.
You can specify conditions based on switch state, item, or skill status.
...
@param commands
@text Command Prohibition Information List
@desc This is a list of prohibited command information.
@type struct<Command>[]
@default []
*/
...
@desc This is a symbol for a menu command. Commands added by plug-ins are not supported in principle.
@type select
@option item
@value item
@option skill
...
@param invalidType
@text Invalid Type
@desc Choose whether to make the command hard-to-select or hidden.
@type select
@default disable
@option Selection prohibited
@value disable
@option hidden
@value hidden
...
@desc The command is prohibited when the specified switch is ON.
@type switch
@default 0

@param noItem
@text No items
@desc Commands are prohibited if you do not have any items.
@type boolean
@default false

@param noSkill
@text No skills
@desc Commands are prohibited if you do not have any skills.
@type boolean
@default false
*/
