...
@plugindesc Script attachments for TextScriptBase
@author Triacontane
@license MIT License
...
various scripts.
You can use \tx[n] and \v[n] in the following situations:

Route setting (Script)
Event command (Conditional branch)
Event command (Script)
Event command (Variable manipulation)

This plugin requires the base plugin "TextScriptBase.js."
