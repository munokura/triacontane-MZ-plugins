...
@plugindesc Character picture display plugin
@author Triacontane
@license MIT License
...
Displays character graphics as pictures.
After specifying a character graphic in the plugin command,
if you set Picture Display to an empty file, the corresponding graphic
will be displayed as a picture.

The cell number specified in the command corresponds to the animation pattern
and orientation
and is assigned numbers 0-11 from the top left to the bottom right.
...
@text Character picture specification
@desc Displays the specified character graphic as a picture.
@arg imageFile
@text file
@desc The file path of the character graphic.
@type file
@dir img/characters
@arg index
@text Index
@desc Character graphic file index (0-7)
@type number
@default 0
@max 7
@arg cell
@text Cell Number
@desc Character graphic cel number (0-11)
@type number
@default 1
@max 11

@command CHANGE_CELL_NUMBER
@text Cell number change
@desc Changes the cel number of the character picture with the specified ID.
@arg pictureId
@text Picture ID
