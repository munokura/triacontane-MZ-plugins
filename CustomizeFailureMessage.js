...
@plugindesc Action failure message setting plugin
@author Triacontane
@license MIT License
...
You can now customize the message displayed when an action fails for each
skill.

Enter the following in the skill's memo field:
<Failure Message: %1aaa> # "[Target Battler Name]aaa" will be displayed.
<FailureMessage: %1aaa> # Same as above.

*Customization is available for the message displayed when an action fails.
This message is not displayed when the opponent evades the action.
