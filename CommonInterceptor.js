...
@plugindesc Interrupt Common Event Plugin
@author Triacontane
@license MIT License
...
Calls a common event at the following times:
...
@param newGameCommon
@text New Game Common
@desc Common event ID called when starting a new game
@type common_event
@default 0

@param loadCommon
@text Road Common
@desc Common event ID called when loading is complete
@type common_event
@default 0

@param menuCommon
@text Menu Common
@desc Common event ID called when the menu screen is closed
@type common_event
@default 0

@param parallel
@text Parallel Processing
@desc Turn it ON if you want to run interrupt commons in parallel.
@type boolean
@default false
*/
