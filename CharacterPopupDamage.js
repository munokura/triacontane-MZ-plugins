...
@param reverse
@text Invert
@desc The rotation direction of the popup will be reversed.
@type boolean
@default false

@param type
@text type
@desc This is the type of popup. The text color changes depending on the type. If you select MISS, the output will also be MISS.
@type select
@default HP
@option HP
@option MP
...
@param critical
@text critical
@desc Critical flag. When enabled, the popup will flash red.
@type boolean
@default false
*/
