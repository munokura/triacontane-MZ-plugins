...
@plugindesc Message Common Plugin
@author Triacontane
@license MIT License
...
Calls a common event while displaying a message.
Common events are executed in parallel.

Execute "Display Text" by including the following control characters:
\CE[1] # Executes Common Event [1].

If the Argument Common Call Plugin is installed,
you can also pass arguments using the following control characters. Only
numeric and string argument types are accepted.
\CEP[1,3,5] # Executes Common Event [1] and passes 3 and 5 as arguments.
