...
@plugindesc Picture Name Variable Setting Plugin
@author Triacontane
@license MIT License
...
You can preset the file to be used by the "Show Picture" event command.
The control character \v[n] can be used, allowing for dynamic filename
specification, such as filenames containing sequential numbers.
After executing the plugin command, display the picture.

Please note that pictures used with this plugin may be subject to the "Exclude
Unused Files" feature.
...
@text Picture Name Settings
@desc You can preset the file name used to display the picture.
@arg name
@text Picture Name
@desc Specifies the file name to use when displaying a picture. No extension is required. Control characters \v[n] can be used.
@type multiline_string
@arg scriptUse
@text Evaluate as a script
@desc Instead of specifying the file name directly, the result of evaluating the script will be used as the file name. For advanced users.
@type boolean
@default false
@arg realTime
@text Real-time changes
@desc Reloads the picture when the variable specified by the control character is changed. This function cannot be used in conjunction with "Evaluate as script".
@type boolean
@default false
*/
