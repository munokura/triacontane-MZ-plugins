...
@plugindesc Balloon position adjustment plugin
@author Triacontane
@license MIT License
...
Adjusts the display coordinates of the balloon.
Enter the following in the event memo field.
<BalloonX:5> # Shifts the balloon's X coordinate to the right [5].
<BalloonY:-5> # Shifts the balloon's Y coordinate up [5].
...
@text No image X coordinate
@desc Adjust the balloon X coordinate for events that do not have an image specified.
@type number
@default 0
@min -2000
@max 2000
...
@text No image Y coordinate
@desc Adjusts the Y coordinate of the balloon for events for which no image is specified.
@default 0
@min -2000
@max 2000

@param BalloonXPlayer
@text Player X coordinate variable
@desc This variable acquires the X coordinate of the player's speech bubble.
@type variable
@default 0

@param BalloonYPlayer
@text Player Y coordinate variable
@desc This variable acquires the Y coordinate of the player's speech bubble.
@type variable
@default 0

@param BalloonXEvent
@text Event X coordinate variable
@desc This variable acquires the X coordinate of the event's balloon. If a value is entered, it takes priority over the value specified in the memo field.
@type variable
@default 0

@param BalloonYEvent
@text Event Y coordinate variable
@desc This variable gets the Y coordinate of the event's balloon. If a value is entered, it takes priority over the value specified in the memo field.
@type variable
@default 0
*/
