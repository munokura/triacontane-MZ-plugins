...
@plugindesc Giant Monster Plugin
@author Triacontane
@license MIT License
...
This plugin allows you to display giant monsters by forcing the bottom of the
monster image to match the bottom of the screen.

Set the enemy character's memo field as follows:
<BigEnemy>
...
@text Animation Y Compensation
@desc Adjusts the Y coordinate of bottom-aligned animations for giant monsters upward by the specified number of pixels.
@type number
@default 0
*/
