...
@plugindesc Picture manipulation extension plug-in
@author Triacontane
@license MIT License
...
Extends the functionality of picture-related event commands.
Executes dedicated plugin commands.
Command details can be found in Plugin Commands.

Various commands (*1) are only effective for pictures that are already
displayed.
Execute the commands after displaying the picture using "Show Picture."

*1 Except for bulk picture operations.
...
@text Bulk operations on pictures
@desc Picture-related event commands can now operate on multiple targets.
@arg all
@text all
@desc All displayed pictures are the target of operation.
@type boolean
@default false
@arg startNumber
@text Starting Number
@desc The starting number of the picture to operate on.
@type number
@default 0
@arg endNumber
@text End Number
...
@default 0
@arg list
@text Direct specification list
@desc A list that directly specifies the pictures to operate on.
@type number[]
@default []
@arg variable
@text variable
@desc The picture to be operated on can be obtained from the specified variable value.
@type variable
@default 0

@command MULTI_CONTROL_CLEAR
@text Cancel bulk operations on pictures
@desc Reverts the operation target of picture-related event commands.

@command PICTURE_SHAKE
@text Shake the Picture
@desc Shake the picture.
@arg pictureId
@text Picture Number
...
@arg duration
@text time
@desc Processing time (in frames).
@type number
@default 0
@min -1
@arg wait
@text Wait until completion
@desc Wait until the process is complete.
@type boolean
@default false

@command PICTURE_OUT_OF_SHAKE
@text Remove from screen shake target
@desc Exclude the picture from screen shake.
@arg pictureId
@text Picture Number
@desc The picture number to operate on.
@type number
...
@arg value
@text Setting value
@desc This is the setting value. If enabled, the picture will be excluded from the screen shake target.
@type boolean
@default true

@command PICTURE_SPIN
@text Picture angle setting
@desc Specify the angle to rotate the picture to.
@arg pictureId
@text Picture Number
@desc The picture number to operate on.
@type number
...
@desc When enabled, the current picture will be rotated by the specified angle.
@type boolean
@default false
@arg duration
@text time
...
@text Picture origin setting
@desc Specifies the origin of the picture in detail.
@arg pictureId
@text Picture Number
@desc The picture number to operate on.
@type number
...
@arg ox
@text Origin X
@desc The origin of the picture's X coordinate, expressed as a percentage.
@type number
@default 0
@min 0
@max 100
@arg oy
@text Origin Y
@desc The Y origin of the picture, specified as a percentage.
@type number
@default 0
@min 0
@max 100
...
@text Align location to map
@desc The picture display position will be adjusted to match the map scroll.
@arg pictureId
@text Picture Number
@desc The picture number to operate on.
@default 1
@arg toMap
@text Fit to Map
@desc The picture display position will be adjusted to the map scroll. Turn it OFF to return to normal.
@type boolean
@default true

@command PICTURE_COPY
@text Copying a Picture
@desc Copy a picture by specifying the source and destination picture numbers.
@arg srcPictureId
@text Source picture number
@desc The picture number to copy from.
@type number
@default 1
@min 1
@arg destPictureId
@text Destination picture number
@desc The picture number to copy to.
@type number
@default 2
@min 1
...
@text Picture Flash
@desc Flash the picture.
@arg pictureId
@text Picture Number
@desc The picture number to operate on.
@default 1
@arg red
@text Flash color (red)
@desc The red component of the flash.
@type number
@default 255
@min 0
@max 255
@arg green
@text Flash color (green)
@desc The green component of the flash.
@type number
@default 255
@min 0
@max 255
@arg blue
@text Flash color (blue)
@desc The blue component of the flash.
@type number
@default 255
@min 0
@max 255
...
@desc The intensity of the flash.
@type number
@default 255
@min 0
@max 255
...
@arg value
@text Setting value
@desc Whether to enable blur.
@type boolean
@default true

@command PICTURE_HUE
@text Change the picture hue
@desc Change the hue of the picture.
@arg pictureId
@text Picture Number
@desc The picture number to operate on.
@type number
...
@arg hue
@text Setting value
@desc This is the setting value for the hue to be changed.
@type number
@default 0
@min 0
@max 360
