...
This plugin implements an auto-battle feature that automatically selects actor
actions.

1. Selecting Auto from the party commands will skip the actor command
selection process and put everyone into auto-battle.

2. Selecting Auto from the actor commands will put the selected actor into
auto-battle mode only.

3. When the auto switch is ON, all command input will be skipped during
battle, and the battle will proceed fully automatically.
...
@desc The name of the bulk autocommand that will be added to the party commands. If left blank, it will not be added.
@default オート

@param PartyCommandIndex
@text Party Command Position
@desc The position where the autocommand will be added in the party command. If it is -1, it will be added to the end.
@default -1

@param ActorCommandName
@text Actor Command Name
@desc The name of the individual autocommand to be added to the actor command. If left blank, it will not be added.
@default オート

@param ActorCommandIndex
@text Actor Command Position
@desc The position in the actor command where the autocommand will be added. If -1, it will be added to the end.
@default -1

@param AutoSwitch
@text Auto Switch
@desc When the specified switch is ON, everyone will always be in auto-battle mode.
@type switch
@default 0
*/
