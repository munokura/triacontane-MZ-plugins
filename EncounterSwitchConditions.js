...
@plugindesc Switch Condition Encounter Plugin
@author Triacontane
@license MIT License
...
Replaces the region ID conditions for encounter creation in map settings with
switches. Normal region ID filtering is disabled.

Example:
Specifying region ID [6] in map settings.

The original region ID [6] condition is ignored, and the specified enemy group
will only be encountered if switch number [6] is ON.
...
@desc The switch ID that enables this plugin's functionality. Specifying 0 will always enable it.
@type switch
@default 0
*/
