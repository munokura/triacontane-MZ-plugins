...
The map screen scrolling will no longer synchronize with the player, but will
instead scroll one screenful if the player moves off-screen. (Similar to The
Legend of Zelda for the Nintendo or Game Boy).

Also, if you move to the edge of the screen using touch and then look
off-screen, the screen will automatically scroll one step forward.

Caution!
After using the "Scroll Screen" command to move the screen, return it to its
original position.
