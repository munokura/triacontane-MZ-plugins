...
@plugindesc Battle End Message Plugin
@author Triacontane
@license MIT License
...
You can display an additional message at the end of battle.
You can also display the message only when the switch is ON.
...
@desc This is the message displayed when a battle is won.
@type multiline_string

@param conditionSwitch
@text Condition Switch
@desc If specified, the message will only be displayed when the switch is ON.
@type switch
@default 0

@param timing
@text Display Timing
@desc The timing of the message display.
@type select
@default 0
@option Immediately after the victory message
@value 0
@option Immediately after the reward message
@value 1
@option Immediately after the Gold acquisition message
@value 2

@param newPage
@text Page forwarding
@desc Page forward before displaying additional messages.
@type boolean
@default true
*/
