...
@plugindesc Cast Time Control Plugin
@author Triacontane
@license MIT License
...
Provides a feature that allows you to change the cast time (casting time)
multiplier in time-progress battles.
Please specify the following in the memo field (※1) of the database that
contains the feature:

- Cast time will be doubled.
<Cast Time Multiplier: 200>
<CastTimeRate: 200>

- Cast time multiplier is only effective for skill type [1].
<Cast Time Multiplier Skill Type: 1>
<CastTimeRateSkillType: 1>

※1 Actor, Class, Weapon, Armor, Enemy Character, State

Cast time will function when a negative value is set for the "Speed
Correction" of a skill, etc.
