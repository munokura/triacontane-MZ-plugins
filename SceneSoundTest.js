...
@param name
@text Category Name
@desc The category name that will be displayed in the category window.

@param audioList
@text Audio List
@desc This is the list of songs displayed in the list window.
@type struct<AUDIO>[]
@default []
*/
...
@param audioFile
@text Audio files
@desc The path to the audio file to play. Select it from the dialog.
@type file
@dir audio

@param name
@text Song title
@desc The song name that will be displayed on the screen. If left blank, the audio file name will be displayed.

@param description
@text explanation
@desc This is the song description that will appear in the help window.
@type multiline_string

@param condSwitch
@text Registration conditions (switch)
@desc The song will be registered when the specified switch is turned ON. If the switch was already ON before setting this parameter, it will be invalid.
@type switch
@default 0

@param defaultRegistered
@text Registered by default
@desc It will be registered and ready to play from the start.
@type boolean
@default false

@param volume
@text volume
@desc The default volume when playing. If not specified, the original volume will be used.
@type number
@min 0
@max 100
...
@param pitch
@text pitch
@desc This is the default pitch when playing. If not specified, the pitch that was originally played will be used.
@type number
@min 50
@max 150

@param pan
@text Phase (left/right balance)
@desc This is the default phase when playing. If not specified, the original phase will be used.
@type number
@min -100
@max 100
...
@param jacket
@text Jacket image
@desc Jacket image. If you use this, please specify the jacket size in the parameters separately.
@type file
@dir img/pictures
*/
