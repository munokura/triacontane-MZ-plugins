...
@plugindesc Message internal display plugin for options
@author Triacontane
@license MIT License
...
The "Choice" window for event commands will now be displayed inside the
message window.
...
@param adjustX
@text X coordinate adjustment
@desc Adjust the X coordinate of the selection window. Set this if the window is not displayed in the desired position due to conflicts, etc.
@type number
@default 0
@min -2000
@max 2000
...
@desc Adjust the Y coordinate of the selection window. Set this if the window is not displayed in the desired position due to conflicts, etc.
@type number
@default 0
@min -2000
@max 2000
