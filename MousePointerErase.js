...
@plugindesc Mouse Pointer Clear Plugin
@author Triacontane
@license MIT License
...
When the mouse pointer is in the game window
The mouse pointer will be hidden when keyboard or gamepad input is detected.
It will reappear when you move the mouse pointer.
