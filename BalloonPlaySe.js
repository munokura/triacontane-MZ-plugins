...
Automatically plays the sound effect specified by the parameter when the
balloon icon appears.
...
@desc This is the speech bubble icon for the sound effect to be played.
@type select
@default 1
@option Surprise
@value 1
