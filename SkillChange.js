...
@plugindesc Skill Change Plugin
@author Triacontane
@license MIT License
...
When a skill is used under the specified conditions, it will transform into a
different skill and activate.
This is determined just before the skill is activated.
If the MP and other costs consumed by the transformed skill are insufficient,
the skill will not change.
...
@param skillList
@text Skill Change List
@desc This is a list of skill change conditions and the resulting skills. If multiple identical skill IDs are specified, the one at the bottom of the list will take priority.
@type struct<Skill>[]
@default []

@param itemList
@text Item Change List
@desc A list of the conditions for changing items and the items they will change into. If multiple identical item IDs are specified, the one at the bottom of the list will take priority.
@type struct<Item>[]
@default []

@param changeMessage
@text Change Message
@desc This is the message that will be displayed in the battle log when a skill changes.
@default %1の%2が%3に変化した！

@param changeAnimation
@text Change animation
@desc The animation ID that will be displayed when the skill changes.
@type animation
@default 0
*/
...
@param skillId
@text Skill ID
@desc The skill ID to be changed.
@type skill
@default 1

@param changeSkillId
@text Transformed Skill ID
@desc The skill ID after the change.
@type skill
@default 0

@param mimicrySkill
@text Imitation skills
@desc When enabled, the skill after transformation will become the skill that someone used immediately before.
@type boolean
@default false

@param condition
@text Change conditions
@desc Conditions for skill change. If nothing is specified, the skill will always change.
...
@param changeItemId
@text Transformed item ID
@desc The item ID after the change.
@type item
@default 0
...
@desc The skill will change if the user's level is equal to or higher than the specified value. (Only actors meet the condition.)
@type number
@default 0

@param ParamType
@text Parameter Conditions
@desc The skill changes when the user's parameters meet the specified conditions.
@type select
@option none
@value
@option HP ratio
...
@param paramValue
@text Parameter Condition Value
@desc The value that satisfies the parameter condition.
@type number
@default 0
@parent ParamType

@param paramMethod
@text Parameter Condition Method
@desc The comparison method for the parameter condition.
@type select
@default >=
@option >=
@option <
...
@desc The skill will change when the specified switch is ON.
@type switch
@default 0

@param actorIdList
@text Actor Conditions
@desc The skill will change when used by the specified actor.
@type actor[]
@default []

@param classIdList
@text Occupational conditions
@desc The skill will change when used by the specified job.
@type class[]
@default []

@param enemyIdList
@text Enemy character conditions
@desc The skill will change when used by a specified enemy character.
@type enemy[]
@default []

@param chain
@text Collaboration conditions
@desc If you are using AttackChain.js, the skill will change when the number of chains reaches the specified value.
@type number
@default 0

@param script
@text Script Conditions
@desc Specify the conditions in the script. When the conditions are met, the skill will change.
@type multiline_string

@param reverse
@text Conditional inversion
@desc The skill will change if the conditions specified in other items are not met.
@type boolean
@default false
*/
