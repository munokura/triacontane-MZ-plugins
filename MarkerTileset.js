...
This allows you to hide specific images from a tileset in-game.
This can be used primarily as a marker that appears only in the editor.

Specify the following in the tile set's memo field:
<Hidden Tiles: A> // Tab [A] will be hidden in-game. Up to E can be specified.
<HiddenTiles: A> // Same as above.

To specify multiple tiles, separate them with commas, as shown below:
<Hidden Tiles: A, B, D>

Only the images will be hidden; passability and other information will remain
intact.
