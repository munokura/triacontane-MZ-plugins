...
@param GlossaryType
@text Term Type
@desc Term type. The term specified in <SG type:n> will be displayed.
@type number
@default 1
@min 1
...
@desc Displays terms divided into categories.
@type boolean
@default false

@param CommandSwitchId
@text Relevance switch
@desc The switch number for the dictionary command's appearance condition. If set to 0, it will be displayed unconditionally.
@type switch
@default 0
...
@param SelectAction
@text Behavior when selected
@desc This is what happens when you select a term.
@type select
@default 0
...
@text Selection switch number
@desc This is the switch number that will be turned ON if the action when selecting a term item is set to switch. Cancel will set it to OFF.
@type switch
@default 0
@parent SelectAction

@param SelectVariableId
@text Selection Term Variable Number
@desc This is the variable number to which the item ID will be set if the action when selecting a term item is to use an item. If canceled, it will be set to -1.
@type variable
@default 0
@parent SelectAction

@param ConfirmMessage
@text Whether to use a confirmation message
@desc A confirmation message will now be displayed when using terminology items.
@type boolean
@default false
...
@desc This is the text to display when confirming the selection of a term item. If not specified, nothing will be displayed. (Line break code: \n)
@parent GlossaryHelp

@param UsingHelp
@text After-use help
@desc The text to display after using the term item. If not specified, nothing will be displayed. (Line break code: \n)
@parent GlossaryHelp

@param CompleteView
@text Collection rate display
@desc Displays the collection rate for each category. This is a guide to completion.
@type boolean
@default false
...
@text Display number of possessions
@desc Displays the number of glossary items you have.
@type boolean
@default false

@param UsableDefault
@text Default availability
@desc This is the initial availability of glossary items. You can change the availability of individual items using the plugin command.
@type boolean
@default true

@param UseItemHistory
@text Use acquisition history
@desc If you turn this on, term items that you have acquired will remain displayed in the dictionary even if you lose them.
@type boolean
@default false

@param GlossaryListWidth
@text Glossary list width
@desc The width of the glossary list window.
@type number
@default 240

@param VisibleItemNotYet
@text Displaying Unobtained Items
@desc Displays unobtained items with the specified name (such as ???). If not specified, this function will be disabled.

@param HideIcon
@text Hiding the icon
@desc Hides the icon regardless of the database settings for the term item.
@type boolean
@default false

@param CancelSwitchId
@text Cancel switch
@desc This is the switch number that turns ON when you cancel on the glossary screen.
@type switch
@default 0
*/
