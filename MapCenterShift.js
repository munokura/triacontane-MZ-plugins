...
@plugindesc Map Center Coordinate Shift Plugin
@author Triacontane
@license MIT License
...
Allows you to shift the center coordinates that define the player's position
on the map screen.

This is useful for displaying character portraits, HUDs, etc. outside of the
map.
...
@param shiftX
@text Shift X coordinate
@desc Shifts the center coordinate of the map horizontally by the specified number of tiles.
@type number
@default 0
@min -2000
@max 2000
...
@param shiftY
@text Shift Y coordinate
@desc Shifts the center coordinate of the map vertically by the specified number of tiles.
@type number
@default 0
@min -2000
@max 2000
...
@param considerEdge
@text Consider scrolling to the edge of the map
@desc When you reach the edge of the map, the extra tile you shifted will scroll.
@type boolean
@default true

@command VALID_SETTING
@text Enable settings
@desc Temporarily change whether or not the map center coordinates are shifted.
@arg valid
@text Enabled Settings
@desc If you disable it, the map function of this plugin will be disabled.
@type boolean
@default true
*/
