...
@plugindesc Actor image window display plugin
@author Triacontane
@license MIT License
...
Hides the actor image on the battle screen and displays it near the window.

You can display actor animations and state overlay animations in a
pseudo-front view.

Set your system settings to "Side View."
...
@param actorHidden
@text Hide Actor
@desc Hides the actor image.
@type boolean
@default true

@param adjustX
@text X coordinate adjustment
@desc Adjusts the display X coordinate of the actor image.
@type number
@default 0
@min -9999
@max 9999
...
@desc Adjusts the display Y coordinate of the actor image.
@type number
@default 0
@min -9999
@max 9999
