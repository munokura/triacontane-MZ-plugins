...
@plugindesc Touch Destination Retention Plugin
@author Triacontane
@license MIT License
...
Touch movement will not be interrupted even if an event is executed during
touch movement.
However, it will stop if the direction of movement is impassable.
