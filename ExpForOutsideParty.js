...
@plugindesc Experience value acquisition plugin for non-party members
@author Triacontane
@license MIT License
...
Allows non-party actors to receive a certain amount of experience points
earned in battle.

An actor outside the party is defined as:

- Substitute members who did not participate in the battle

- Members who have joined the party at least once but are no longer in the
party

Note that this plugin cannot be used with save data prior to application.

You can also specify the experience point percentage (%) in the memo field.

If this is specified, the plugin parameter value will be ignored.

Please enter the following in the memo field for the actor, job, weapon,
armor, and state.

If multiple values are defined, the larger value will take precedence.

<OutsidePartyExpRate:50> # Sets the experience point gain rate to 50%
<Outside Party EXP Rate:50> # Same as above
...
@param expPercent
@text Experience point acquisition rate
@desc The percentage of experience points that reserve members can receive.
@type number
@default 100

@param expPercentForOutParty
@text Experience gain rate outside the party
@desc The percentage of experience points that non-party members can receive.
@type number
@default 100

@param showLevelUpMessage
@text Level up message display
@desc Choose whether to display a message when a non-party member levels up.
@type boolean
@default true
*/
