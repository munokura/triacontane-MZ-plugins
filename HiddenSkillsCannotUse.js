...
@plugindesc Unavailable Skill Hide Plugin
@author Triacontane
@license MIT License
...
Hides unavailable skills in the skill selection window during battle.

They appear normally on the menu screen.
...
@param ignoreCost
@text Ignoring cost shortfalls
@desc Skills that cannot be used due to insufficient costs are not covered by this plugin (they will not be hidden).
@type boolean
@default false

@param validInMenu
@text Also valid on the menu screen
@desc The functions of this plugin are applied not only to the battle screen but also to the menu screen, and unavailable items will be hidden.
@type boolean
@default false

@param ignoreSkills
@text Excluded Skills List
@desc This is a list of skills that are not covered by this plugin (are not hidden).
@type skill[]
@default []
*/
