...
@plugindesc Battlelog message display plugin
@author Triacontane
@license MIT License
...
Changes the display of the battle log to a message window at the bottom of the
screen.
You can change the display method and specifications in the plugin parameters.
...
@text Status top placement
@desc Place command and status windows at the top of the screen so they are not obscured by messages.
@type boolean
@default false

@param MessagePosUpper
@text Message top placement
@desc Display the message window at the top. In that case, disable the status top placement.
@type boolean
@default false

@param MessageSpeed
@text Message Rate Variable
@desc Changes the message speed to be obtained from the variable with the specified number. The value of the variable will be the frame value.
@type number
@default 0

@param WaitForEndAction
@text Wait after the action is completed
@desc After the action is completed, the message will wait for the specified number of frames before being cleared.
@type number
@default 0
...
@param MessageLines
@text Message Line Count
@desc The number of lines in the window. If you reduce the number of lines, messages such as damage indication may not be displayed.
@type number
@default 2

@param HiddenIfEmpty
@text Hide if empty
@desc When a window has no content to display, it becomes hidden.
@type boolean
@default false

@command LOG_CLOSE
@text Close the log window
@desc Close the log window.

@command LOG_OPEN
@text Open the log window
@desc Reopens the log window if it was closed.
*/
