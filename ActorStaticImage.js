...
@plugindesc Actor image single image plugin
@author Triacontane
@license MIT License
...
Changes actor images to single still images.
After placing a single image in img\sv_actors, select it in the editor as
usual.

You can temporarily disable this plugin's functionality with a switch.
Also, if you want to freely set the display coordinates based on party order,
please set it in the plugin parameters.
...
@param invalidSwitch
@text Disable Switch
@desc When the specified switch is ON, the plugin function will be disabled. If 0 is specified, it will always be enabled.
@type switch
@default 0

@param disableMove
@text Movement Prohibition
@desc All movement motions of actor images are also disabled.
@type boolean
@default true

@param positionList
@text Display coordinate list
@desc A list of display coordinates for each party. If not specified, the default position will be used.
@type struct<POS>[]
@default []
*/
...
@param x
@text X coordinate
@desc The display X coordinate of the butler.
@type number
@default 0

@param y
@text Y coordinate
@desc The display Y coordinate of the butler.
@type number
@default 0
*/
