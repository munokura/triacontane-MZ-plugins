...
@plugindesc Damage Pop Background Image Plugin
@author Triacontane
@license MIT License
...
Allows you to specify a background image for the damage popup.
You can specify different images for damage and recovery.
...
@text Damage Background List
@desc A list of background images for when you receive damage or recovery. The first image that meets the conditions will be displayed.
@type struct<Image>[]
@default []

@param offsetX
@text X coordinate adjustment value
@desc The X coordinate adjustment value for the damage pop.
@type number
@default 0
@min -2000
@max 2000
...
@desc The Y coordinate adjustment value for the damage pop.
@type number
@default 0
@min -2000
@max 2000
...
@desc The opacity of the background image.
@type number
@default 255
@min 0
@max 255
...
@desc Background image when taking damage
@type file
@dir img/pictures

@param damageType
@text Damage Type
@desc Specify the damage in either HP or MP.
@type select
@default hp
@option HP
@value hp
...
@param damageUpper
@text Damage Limit
@desc Displayed when the damage is below the specified value.
@type number

@param damageLower
@text Damage Lower Limit
@desc Plays when damage is greater than or equal to the specified value.
@type number

@param miss
@text Miss Conditions
@desc This will be displayed if there is an error.
@type boolean
@default false
*/
