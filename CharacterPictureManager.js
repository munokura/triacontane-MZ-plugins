...
@param ActorId
@text actor
@desc The actor for which the portrait will be displayed.
@type actor
@default 1

@param Name
@text name
@desc This is a name to distinguish it. It has no special meaning in the plugin.

@param Opacity
@text Opacity
@desc The opacity of the portrait.
@type number
@default 255
@max 255

@param X
@text Unique X coordinate
@desc The X coordinate of the character image. The actual display coordinate is the sum of the reference coordinate for each scene.
@type number
@default 0
@min -9999
@max 9999
...
@param Y
@text Intrinsic Y coordinate
@desc The Y coordinate of the character image. The actual display coordinate is the value obtained by adding the reference coordinate for each scene.
@type number
@default 0
@min -9999
@max 9999
...
@desc The horizontal magnification of the character portrait.
@type number
@default 100
@max 1000
...
@desc The vertical magnification of the character portrait.
@type number
@default 100
@max 1000
...
@param ShakeSwitch
@text Shake Switch
@desc When the specified switch is turned ON, the character will shake. After shaking, the switch will automatically turn OFF.
@type switch
@default 0

@param OutOfShake
@text Not eligible for Shake
@desc This image part will be excluded from the character shake.
@type boolean
@default false

@param SpriteSheet
@text sprite sheet
@desc Specify this if you want to obtain the character image from a sprite sheet.
@type struct<SpriteSheet>

@param FileList
@text Character image list
@desc A list of the portraits to display and the conditions. Only one portrait that meets the conditions will be displayed (priority is given to the bottom of the list).
@type struct<StandPicture>[]
@default []

@param DynamicFileName
@text Dynamic File Name
@desc Dynamically generate character image file names. If there is a file in the character image list that meets the conditions, that file will be prioritized.
@type combo
...
@text Display Switch
@desc If specified, the character portrait will only be displayed when the switch is ON.
@type switch
@default 0

@param UnFocusSwitch
@text Unfocus switch
@desc If specified, the character portrait will be darkened when the switch is ON.
@type switch
@default 0

@param MirrorSwitch
@text Reverse switch
@desc If specified, the character portrait will be inverted when the switch is ON.
@type switch
@default 0

@param TouchSwitch
@text Touch switch
@desc If specified, touching or clicking the picture will turn the switch ON. The transparent color of the picture will not be taken into account.
@type switch
@default 0
*/
...
@param FileName
@text File name
@desc The file name of the portrait.
@type file
@dir img/pictures

@param BlendMode
@text Synthesis method
@desc This is how to composite a standing image.
@type select
@default 0
@option usually
@value 0
...
@param HpUpperLimit
@text HP condition (upper limit)
@desc The display condition is met when the HP percentage is below the specified value. If 0 is specified, the condition will not be judged.
@type number
@default 0
@min 0
@max 100
...
@param HpLowerLimit
@text HP condition (lower limit)
@desc The display condition is met when the HP percentage is equal to or greater than the specified value. If you specify 0, the condition will not be judged.
@type number
@default 0
@min 0
@max 100
...
@desc The display condition is met when the actor is inputting commands. The display condition is met at all times except during combat.
@type boolean
@default false

@param InputCommand
@text Input command conditions
@desc Specify the target command when the input condition is enabled. If you set None, the display condition will always be met.
@type select
@option なし
@option attack
@value attack
...
@text Input skill type conditions
@desc Specifies the target skill type when the input command condition is set to skill.
@type number
@default 1
@min 1
@parent Inputting
...
@desc The display condition is met when the actor is in action. The display condition is met at all times except during combat.
@type boolean
@default false

@param Motion
@text Motion Conditions
@desc The display condition is met while the actor is performing the specified motion. It also works in front view. The display condition is not met outside of combat.
@type select
@option なし
@option forward
@value walk
...
@desc The display condition is met when the specified state is valid. If 0 is specified, the condition will not be judged.
@type state
@default 0

@param Weapon
@text Weapon conditions
@desc The display condition will be met if the specified weapon is equipped. If 0 is specified, the condition will not be judged.
@type weapon
@default 0

@param Armor
@text Armor Requirements
@desc The display condition is met when the specified armor is equipped. If 0 is specified, the condition will not be judged.
@type armor
@default 0

@param Scene
@text Scene Conditions
@desc The display condition is met when the current scene is the selected scene.
@type select
@default none
@option 条件なし
@option title
...
@desc The display condition is met when the database memo field <StandPicture:aaa> is equal to the specified value.

@param Message
@text Message Conditions
@desc If specified, the condition will be met only while the message is being displayed.
@type boolean
@default false

@param Face
@text Face Conditions
@desc If specified, the condition will be met when the message is being displayed and the face image matches the actor's face.
@type boolean
@default false

@param Speaker
@text Speaker Requirements
@desc If specified, the condition is met when a message is being displayed and the message name matches the actor's name.
@type boolean
@default false

@param Switch
@text Switch Condition
@desc The display condition is met when the specified switch is ON. If you specify 0, the condition will not be judged.
@type switch
@default 0

@param Variable
@text Variable Condition
@desc The display condition is met when the specified variable satisfies the condition. Specify the judgment type and operand separately.
@type variable
@default 0

@param VariableType
@text Judgment type
@desc This is a method of comparing a variable with a value. The variable value is on the left side and the operand is on the right side.
@type select
@default 0
@option = (equal to)
@value 0
...
@text operand
@desc The value to be compared with the variable. If you want to compare with the variable value, specify the control character \v[n].
@type number
@default 0
@min -999999999
@parent Variable
...
@desc The display condition is met when the specified script returns true. You can refer to the actor object with a.
@type combo
@option a.mpRate() < 0.5; // MP is below 50%
@option a.tpRate() < 0.5; // TP is below 50%
*/

/*~struct~Scene:
@param SceneName
@text Target Scene
@desc The scene to be displayed. If you want to display the original scene, enter the scene class name directly.
@type select
...
@text Reference coordinates for each member
@desc These are the reference coordinates for each member's standing image. Register only the number of party members.
@type struct<Position>[]
@default ["{\"X\":\"160\",\"Y\":\"480\"}","{\"X\":\"320\",\"Y\":\"480\"}","{\"X\":\"480\",\"Y\":\"480\"}","{\"X\":\"640\",\"Y\":\"480\"}"]

@param ActorPosition
@text Reference coordinates for each actor
@desc Specify this if you want to determine the reference coordinates for each actor. If specified, it will take priority over the reference coordinates for each member.
@type struct<ActorPosition>[]
@default []

@param ScaleX
@text X Magnification
@desc The horizontal magnification of the standing image.
@type number
@default 100
@max 1000
...
@desc This is the display priority of the character portrait. If you want to include the character portrait in the fade-out screen, select 2.
@type select
@default 0
@option frontmost
@value 0
@option Under the window
@value 1
@option Under animation (only valid for battle and map screens)
@value 2

@param FadeFrame
@text Fade Time
@desc If specified, the character portrait will fade in/out when the display is switched on/off.
@type number
@default 0

@param CrossFadeFrame
@text Crossfade Time
@desc If specified, the displayed character portraits will crossfade when they are switched.
@type number
@default 0

@param UpdateInterval
@text Update interval
@desc This is the interval for checking the display conditions of character portraits. Change this if displaying a large number of character portraits causes performance degradation.
@type number
@default 1

@param UpdateSwitch
@text Update Switch
@desc When the switch is ON, the display conditions for the character portrait will be checked. If this setting is enabled, automatic updates per frame will be disabled.
@type switch
@default 0
*/
...
/*~struct~Position:
@param X
@text Reference X coordinate
@desc The reference X coordinate of the character portrait.
@type number
@default 0
@min -9999
@max 9999
...
@param Y
@text Reference Y coordinate
@desc The reference Y coordinate of the character portrait.
@type number
@default 0
@min -9999
@max 9999
...
@param ActorId
@text Actor ID
@desc The actor ID for which to set the reference coordinates.
@type actor
@default 1
...
@desc The total number of columns (vertical) in the sprite sheet.
@type number
@default 1
@min 1
...
@param MaxRow
@text Number of rows
@desc The total number of rows (horizontal) in the sprite sheet.
@type number
@default 1
@min 1
...
@param ColumnNumber
@text Column number
@desc The line number (vertical) of the part you want to extract.
@type number
@default 1
@min 1
...
@param RowNumber
@text Line number
@desc The row number (horizontal) of the part you want to extract.
@type number
@default 1
@min 1
*/
