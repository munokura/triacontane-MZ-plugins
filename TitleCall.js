...
Plays the specified sound effect when the title screen is displayed.
...
@param pan
@text SE Phase
@desc This is the phase (position) of the SE to be played.
@type number
@default 0
@min -100
@max 100
...
@param delay
@text Latency (ms)
@desc Delays the SE performance by the specified number of milliseconds.
@type number
@default 0
@max 99999
...
@param bgmDelay
@text BGM Delay (ms)
@desc Delays the default title music by the specified number of milliseconds.
@type number
@default 0
@max 99999

@param randomList
@text Random SE File List
@desc Once set, the songs will be played randomly from the list.
@type file[]
@default []
@dir audio/se
...
@desc These are the conditions for triggering the title call. This is for advanced users as it requires writing a script.
@type combo
@option ConfigManager.Boolean1; // Switch items in CustomizeConfigItem.js
*/
