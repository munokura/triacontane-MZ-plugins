...
@param unit
@text unit
@desc This is the display unit. "Chain!!" or "Damage!!" will be displayed to the right of the number.

@param unitFont
@text Unit Font
@desc Font setting for units.
@type struct<Font>

@param valueFont
@text Numeric Font
@desc Font settings for numbers.
@type struct<Font>
*/
...
@param face
@text Font Name
@desc Font name. If specified, a separate font loading plug-in is required.

@param size
@text Font size
@desc Font size. If not specified, it will default to the system size.
@default 0
...
@param color
@text Font color
@desc Font color. Select from the text color.
@type color
@default 0

@param outlineColor
@text Outline Color
@desc Outline color. Select from the text color.
@type color
@default 0

@param outlineWidth
@text Outline Width
@desc The outline width.
@type number
@default 4

@param image
@text Image files
@desc Uses an image instead of a font, which takes precedence if specified.
@type file
@dir img/system/
*/
...
@param skillId
@text Skill ID
@desc The ID of the skill for which you want to configure the integration.
@type skill
@default 0

@param itemId
@text Item ID
@desc The ID of the item for which you want to configure the link.
@type item
@default 0

@param rate
@text Damage Multiplier
@desc Sets skill-specific chain damage multiplier.
@type number
@default 100

@param finish
@text End of collaboration
@desc If you use this skill, the link will be terminated.
@type boolean
@default false

@param countCondition
@text Number of collaborations
@desc The skill will only succeed if the number of combos is equal to or greater than the specified value.
@type number
@default 0
*/
