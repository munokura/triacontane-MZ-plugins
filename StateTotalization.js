...
@plugindesc State Globalization Plugin
@author Triacontane
@license MIT License
...
Extends the effects of certain states to all members.
Enter the following in the state's memo field:
<ST_All>

The characteristics and behavioral restrictions of the state described in the
memo field will be applied to all members.
However, since the state itself is not infected, no icon or message will be
displayed.
...
@desc Limits the target of the generalized state to combat members. If you turn it off, the state of non-combat members will also be generalized.
@type boolean
@default true
*/
