...
@plugindesc Game End Customization Plugin
@author Triacontane
@license MIT License
...
Customizes the game end screen.
...
@param load
@text Load Item Name
@desc The name of the item to load.
@default ロード

@param shutdown
@text Shutdown Item Name
@desc The shutdown item name.
@default シャットダウン

@param itemNumber
@text Number of items
@desc The number of items in the game end window. If not specified, the number of items specified in the sort order will be used. This is only used when specifying a conflict, etc.
@type number
@default 0

@param orderList
@text Sort order
@desc This is the order of items in the End Game window. Delete any unnecessary items.
@type select[]
