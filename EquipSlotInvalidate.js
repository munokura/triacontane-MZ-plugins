...
This command disables an actor's equipment slot.
Equip equipped in a disabled slot will no longer be effective.
The equipment itself will remain, but all stat changes and features will be
disabled.
...
Invalidation can be specified in the memo field or plugin command.

Enter the following in the memo field for features such as states:
<EquipInvalid:1> # Disable slot [1]
<EquipInvalid:1> # Same as above
...
@text Change slot validity
@desc Disables the specified slot. Any equipment equipped in the disabled slot will no longer be effective.
@arg actorId
@text Actor ID
@desc The actor ID to be invalidated.
@type actor
@default 1
@arg slotIndex
@text Slot number
@desc The slot number to disable. Corresponds to the order of the equipment types.
@type number
@default 1
@min 1
@arg validation
@text Enabled state
@desc Specify ON to enable it, or OFF to disable it.
@type boolean
@default true
*/
