...
@plugindesc Unequipment prohibition plugin
@author Triacontane
@license MIT License
...
This parameter prevents the removal of equipment of the specified equipment
type.
This also prevents the "Remove All" command from being executed.
Initial equipment with no equipment is not considered.
Please equip an item in the database.
...
@desc A list of equipment types that are prohibited from being unequipped.
@type number[]
@default []
*/
