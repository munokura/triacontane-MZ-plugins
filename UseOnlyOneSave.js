...
@plugindesc Single save data plugin
@author Triacontane
@license MIT License
...
This changes the loading or saving process to always use only file 1,
bypassing each screen.

If autosave is enabled, the latest data will be loaded.
...
@param saveMessage
@text Save Message
@desc This is the message to be displayed when saving from the menu screen. If not specified, it will not be displayed.
@type string
@default プレイデータをセーブしました。

@command Load
@text Loading save data
@desc Loads the latest data. Nothing will happen if you run this without any saved data.
*/
