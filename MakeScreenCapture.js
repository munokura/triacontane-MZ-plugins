...
@param pan
@text phase
@desc The phase of the sound effect.
@type number
@default 0
@min -100
@max 100
...
@param signature
@text Signature Text
@desc This is the signature text. You can use control characters \v[n].
@type string

@param image
@text Signature Image
@desc This is the file name if you want to specify an image for your signature. Use the one stored in the Pictures folder.
@type file
@dir img/pictures/

@param fontFace
@text Signature Font
@desc Use this if you want to change the signature font from the main font. A separate font load plugin is required.
@type string

@param fontSize
@text Signature Size
@desc Signature font size. If omitted, it will use the main font size.
@type number
@default 0

@param fontColor
@text Signature Color
@desc The font color of the signature. Choose from text colors.
@type color
@default 0

@param align
@text Signature alignment
@desc The signatures are aligned.
@type select
@default right
@option left
@option center
...
@param x
@text X coordinate
@desc The X coordinate of the area to be trimmed. If you want to specify a variable value, use the control character \v[n].
@type number
@default 0

@param y
@text Y coordinate
@desc The Y coordinate of the area to be trimmed. If you want to specify a variable value, use the control character \v[n].
@type number
@default 0

@param width
@text width
@desc The width of the trimming area. If you want to specify a variable value, use the control character \v[n].
@type number
@default 1
@min 1
...
@param height
@text height
@desc The height of the area to be trimmed. If you want to specify a variable value, use the control character \v[n].
@type number
@default 1
@min 1
*/
