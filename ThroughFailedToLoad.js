...
@plugindesc Plug-in that bypasses load failure errors
@author Triacontane
@license MIT License
...
Ignores errors that occur when non-existent image or audio material is
specified.
If audio is specified, nothing will be played, and if image is specified, an
empty transparent image will be set.

Error logs will be output as usual.
...
@param InvalidIfTest
@text Disabled during test play
@desc The functions of this plugin will be disabled during test play.
@type boolean
@default true

@param InvalidIfWeb
@text Disabled on the web version
@desc The functionality of this plugin will be disabled when running the web version.
@type boolean
@default false

@param ThroughType
@text Ignore Type
@desc The type of material to ignore.
@type select
@default 3
@option Audio only
@value 1
