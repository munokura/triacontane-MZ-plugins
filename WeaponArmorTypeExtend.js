...
@plugindesc Weapon Type Expansion Plugin
@author Triacontane
@license MIT License
...
Allows you to add weapon and armor types. This affects equipment requirements.
Specify the following in the weapon or armor memo field:
<Add Weapon Type: 1> # Adds weapon type [1].
<AddWeaponType: 1> # Same as above
<Add Armor Type: 2, 3> # Adds armor types [2] and [3].
<AddArmorType: 2, 3> # Same as above
...
@text Equipment Condition Type
@desc You can select "All" or "Any" as the equipment conditions for weapons with multiple types.
@type select
@default 0
@option All
@value 0
