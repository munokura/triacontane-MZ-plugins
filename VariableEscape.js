...
@plugindesc Plug-in that allows control characters in variable values
@author Triacontane
@license MIT License
...
When a variable value contains a string containing control characters, the
control characters will be reflected in the text display. (By default, control
characters are displayed as is.)

When setting a variable value from a script, double backslashes, as shown in
the example below.
\\i[i] \\v[i]
