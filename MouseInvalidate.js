...
@plugindesc Touch Disable Plugin
@author Triacontane
@license MIT License
...
Completely disables mouse and touch controls throughout the game.
...
@desc If specified, mouse and touch operations will be disabled only when the switch is ON.
@type switch
@default 0
*/
