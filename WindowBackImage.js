...
@plugindesc Window background image specification plugin
@author Triacontane
@license MIT License
...
Replaces the window background with any image.
Multiple images can be specified, and appearance conditions can be set for
each.
When the image is displayed, you can choose whether to hide the original
window frame.

The background image is displayed at the center of the window, regardless of
the window size.
While you can adjust the zoom and coordinates, we do not recommend specifying
a background image for windows with variable or indefinite sizes.

You can also specify a background image for windows added by plugins, but this
may not work properly.

If you want to change the background of a window added with
SceneCustomMenu.js, specify the "window identifier" of the plugin instead of
the WindowClass.
...
@desc Information about the window whose background image you want to replace.
...
@param WindowClass
@text window
@desc This is the window to be replaced with a dedicated image. If it is not in the list, please enter it directly.
@type select
@option [General Game] Help window
@value Window_Help
@option [General Game] Money Window
@value Window_Gold
@option [General Game] Icon Description Window (requires plugin)
...
@option [Title Screen] Title Help Window
...
@option [Sound Test Plugin] Sound Category Window
@value Window_SoundCategory
@option [Sound Test Plug-in] Sound List Window
@value Window_SoundList
@option [Sound Test Plugin] Audio Settings Window
@value Window_AudioConfig
@option [Sound Test Plug-in] Audio Window
@value Window_Audio
@option [Sound Test Plugin] Audio Seekbar Window
...
@option [Battle Retry Plugin] Retry window
@value Window_RetryCommand

@param ImageFile
@text Replacement file name
@desc The file name of the image to replace. (Select from img/picture) If you specify empty, only the frame will be hidden.
@type file
@dir img/pictures/

@param ImageFileHover
@text Hover File Name
@desc The file name of the image that will be replaced when you hover the mouse over it.
@type file
@dir img/pictures/

@param Origin
@text origin
@desc The origin of the background image.
@type select
@default 1
@option Top left (the top left of the window and the top left of the image match)
@value 0
@option Center (the center of the window and the center of the image are aligned)
@value 1

@param OffsetX
@text X coordinate correction
@desc Correction value for the display X coordinate.
@type number
@default 0
@min -2000
@max 2000
...
@desc Display Y coordinate correction value.
@type number
@default 0
@min -2000
@max 2000
...
@param ScaleX
@text Magnification (width)
@desc X-axis magnification (specified in %).
@type number
@default 100
@min -2000
@max 2000
...
@param ScaleY
@text Magnification (height)
@desc Magnification rate in the Y direction (specified as a percentage).
@type number
@default 100
@min -2000
@max 2000
...
@desc Keeps the original background of the window visible.
@type boolean
@default true

@param ItemHide
@text Hide items
@desc Hides the contents of the window.
@type boolean
@default false

@param ItemBackHide
@text Hide item background
@desc Hides the window's item background.
@type boolean
@default false

@param CursorHide
@text Cursor Hidden
@desc Hides the window cursor.
@type boolean
@default false

@param AllHide
@text Hide all
@desc Hides the entire window. Use with caution.
@type boolean
@default false

@param SwitchId
@text Replacement switch number
@desc The window will be replaced only when the specified switch is ON.
@type switch
@default 0

@param Openness
@text Opening and closing conditions
@desc The window will only be replaced if the opening/closing degree of the window is greater than or equal to the specified value.
@type number
@default 0
@max 255
...
@param Padding
@text Window Margins
@desc Change the window margins. The default value is 12. If you change it, you may need to adjust the window height and width.
@type number
@default 0

@param Font
@text Font-related settings
@desc These are settings related to window skins and fonts. These settings are applied regardless of the replacement switch.

@param WindowSkin
@text Window Skin
@desc This is a dedicated window skin image. This setting is applied regardless of the replacement switch.
@type file
@dir img/system/
@parent Font
...
@param FontFace
@text font
@desc This is a dedicated font for windows. Please specify the woff file with the extension.
@parent Font

@param FontSize
@text Font size
@desc The base font size for the window.
@type number
@default 0
@parent Font
...
@param FontColor
@text Font color
@desc The window text color number. Select from the text colors or specify it directly in CSS format (e.g., rgba(0,0,0,0)).
@type color
@default 0
@parent Font
...
@param OutlineWidth
@text Outline Width
@desc The width of the window's text outline.
@type number
@default 3
@parent Font
*/
