...
@plugindesc Option Reset Plugin
@author Triacontane
@license MIT License
...
Provides a command to reset all settings in the Options screen to their
defaults.
...
@param commandName
@text Command Name
@desc The name of the command to reset to default settings.
@type string
@default - デフォルト設定に戻す -
*/
