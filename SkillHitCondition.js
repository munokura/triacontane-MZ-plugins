...
@plugindesc Skill hit condition setting plugin
@author Triacontane
@license MIT License
...
You can set special hit conditions for skills and items.
You can create skills that always fail unless a specific state is met.

Set the following in the skill or item's memo field.
id is the identifier specified in the plugin parameters.
<HitCondition:id>

If the condition is not met, the skill will simply fail; it can still be used.
...
@param conditionList
@text Hit Condition Setting List
@desc A list of skill and item hit condition settings.
...
@param id
@text identifier
@desc This is the identifier for skill or item notetags. Please specify a unique value.
@default id

@param subjectState
@text User State
@desc The action will succeed if the user is in the specified state.
@type state
@default 0

@param targetState
@text Target State
@desc The action will succeed if the target is in the specified state.
@type state
@default 0

@param subjectTag
@text User Tag
@desc The action will succeed if the user has a tag with the specified name <aaa>.

@param targetTag
@text Target audience tag
@desc The action will succeed if the target has a tag with the specified name <aaa>.

@param switchId
@text switch
@desc The action will succeed when the specified switch is ON.
@type switch
@default 0

@param script
@text script
@desc The action will succeed if the execution result of the specified script is true.
@type combo
@option subject.hpRate() < 0.5; // User's HP is below 50%
@option target.mp === 0; // Target's MP is 0

@param reverse
@text Invert
@desc All conditions are reversed and the action "fails" when the conditions are met.
@type boolean
@default false
*/
