...
/*~struct~RESTRICTION:
@param skillId
@text Target skill ID
@desc The skill ID to be constrained.
@type skill
@default 0

@param itemId
@text Target item ID
@desc The item ID to be constrained.
@type item
@default 0

@param tagName
@text Target tag name
@desc This is the tag name that is the target of the restriction. Multiple tags can be restricted at once. Write it in the memo field of the skill or item. Example: <xxx>

@param validActors
@text Valid Actors
@desc It will only be available to the specified actor. If empty, no condition will be applied.
@type actor[]

@param invalidActors
@text Disabled Actors
@desc It will be disabled for the specified actor. If empty, no condition will be applied.
@type actor[]

@param validEnemies
@text Effective enemy characters
@desc This can only be used on the specified enemy character. If you specify the sky, the condition will not be applied.
@type enemy[]

@param invalidEnemies
@text Invalid enemy characters
@desc It cannot be used on the specified enemy character. If you specify the sky, the condition will not apply.
@type enemy[]

@param validNote
@text Valid Notetags
@desc This can only be used for battlers with the specified memo field <xxx>. Actors, enemy characters, weapons, armor, jobs, and states are eligible.

@param invalidNote
@text Disabled Notetags
@desc It will be unavailable to battlers with the specified memo field <xxx>. This applies to actors, enemies, weapons, armor, jobs, and states.

@param invalidUser
@text Invalid for users
@desc It cannot be used against the skill's user.
@type boolean
@default false

@param script
@text script
@desc If the script execution result returns true, it will be disabled.
@type multiline_string

@param invalidTargetHidden
@text Disabled Battler Hide
@desc This option hides battlers who cannot use skills, instead of making them unselectable. This is only effective when targeting enemy characters.
@type boolean
@default false
*/
