...
This allows you to center or right-align messages, skill descriptions, and
other text.
You can change the alignment by placing the following control characters at
...
Adding a number after the control character will shift the drawing position to
the left by the specified number of pixels.
\ac[20]

This will not be reflected in the message preview.
Control characters must be placed at the beginning of a line.
Only one vertical alignment can be specified per sentence.
Always place them at the beginning of the sentence.
Right-to-left languages are not supported in the current version.
