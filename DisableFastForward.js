...
@plugindesc Event acceleration prohibition plugin
@author Triacontane
@license MIT License
...
This disables the feature that doubles the game speed by holding down the
Confirm button during an event.

This does not disable the message fast-forward feature by holding down the
Confirm button.
...
@desc Disables event acceleration when the specified switch is ON. Specifying 0 disables it at all times.
@type switch
@default 0
*/
