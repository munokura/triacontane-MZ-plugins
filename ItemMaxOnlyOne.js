...
@plugindesc Multiple item possession restriction plugin
@author Triacontane
@license MIT License
...
Limits the maximum number of items possessed to one.
When this is set, you can remove the possession count from the menu screen.

If a restricted item is assigned as initial equipment to multiple actors,
all actors except the first will be unequipped.
...
@param condition
@text conditions
@desc This is the condition for items whose possession limit is set to 1. If not set, the possession limit for all items will be set to 1.
@type select
@default noCondition
@option unconditional
@value noCondition
@option Contains notetags
@value hasMeta
@option Does not contain notetags
@value noMeta

@param tagName
@text Notetag Name
@desc The notetag name if the condition is include/exclude notetag. Written as <aaa> in the item database.
@default aaa

@param itemNumberHidden
@text Hide number of possessions
@desc If you set the possession limit to 1, the quantity of the item will not be displayed on the menu screen.
@type boolean
@default true
*/
